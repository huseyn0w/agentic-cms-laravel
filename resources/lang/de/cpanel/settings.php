...
return [
    ...
    'tab_geo' => 'GEO',
    'tab_aeo' => 'AEO',
    'aeo_settings_headline' => 'AEO-Einstellungen',
    'aeo_crawlers_section' => 'KI-Crawler',
    'aeo_crawlers_help' => 'Answer-Engine- und KI-Crawler sind standardmäßig erlaubt. Schalte einen aus, um in der robots.txt eine Disallow-Regel dafür hinzuzufügen.',
    'aeo_settings_updates_success' => 'AEO-Einstellungen wurden aktualisiert',
    ...
    // Theme (Tier-1-Design)
    'theme_settings_headline' => 'Design-Einstellungen',
    'theme_settings_updates_success' => 'Design-Einstellungen wurden aktualisiert',
    'theme_intro' => 'Gestalte die öffentliche Website ohne Neuaufbau neu. Diese Werte werden auf jeder Seite als CSS-Variablen angewendet.',
    'theme_brand_section' => 'Marke',
    'theme_appearance_section' => 'Darstellung',
    'theme_site_title' => 'Website-Titel',
    'theme_accent_color' => 'Akzentfarbe',
    'theme_font_family' => 'Schriftart',
    'theme_radius' => 'Eckenradius (px)',
