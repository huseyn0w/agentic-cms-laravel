 ...
 * Date: 14.11.2019
 * Phase 5d: ported to <x-button variant="outline"> per DESIGN_SYSTEM §5 social-login pattern.
 */
?>

<div class="grid grid-cols-1 gap-2.5 sm:grid-cols-3">
    <x-button href="{{ url('/login/github') }}" variant="outline" size="sm">
    ...
    <x-button href="{{ url('/login/facebook') }}" variant="outline" size="sm">
