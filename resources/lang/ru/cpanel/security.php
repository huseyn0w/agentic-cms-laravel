...
return [
    ...
    // Site lockdown
    'lockdown_headline' => 'Приватный режим сайта',
    'lockdown_subtitle' => 'Сделать публичный сайт приватным. Неавторизованных посетителей перенаправляет на страницу входа; админка и вход остаются доступными.',
    'lockdown_enabled' => 'Требовать вход для просмотра публичного сайта',
