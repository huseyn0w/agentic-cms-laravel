...
return [
    ...
    'tab_geo' => 'GEO',
    'tab_aeo' => 'AEO',
    'aeo_settings_headline' => 'Настройки AEO',
    'aeo_crawlers_section' => 'AI-краулеры',
    'aeo_crawlers_help' => 'Answer-engine и AI-краулеры разрешены по умолчанию. Выключите любой, чтобы добавить для него правило Disallow в robots.txt.',
    'aeo_settings_updates_success' => 'Настройки AEO обновлены',
    ...
    // Тема (Tier-1 темизация)
    'theme_settings_headline' => 'Настройки темы',
    'theme_settings_updates_success' => 'Настройки темы обновлены',
    'theme_intro' => 'Меняйте оформление публичного сайта без пересборки. Значения применяются как CSS-переменные на каждой странице.',
    'theme_brand_section' => 'Бренд',
    'theme_appearance_section' => 'Оформление',
    'theme_site_title' => 'Название сайта',
    'theme_accent_color' => 'Акцентный цвет',
    'theme_font_family' => 'Шрифт',
    'theme_radius' => 'Радиус скругления (px)',
